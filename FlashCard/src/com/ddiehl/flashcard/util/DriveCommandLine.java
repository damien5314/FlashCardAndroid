...
public class DriveCommandLine {
	private static final String TAG = DriveCommandLine.class
			.getSimpleName();
	...
	public static void uploadFileToDrive(Context ctx) throws Exception {
		...
		Log.i(TAG, "Please open the following URL in your browser then type the authorization code:");
		Log.i(TAG, "  " + url);
